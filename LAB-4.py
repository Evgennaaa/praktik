...
def get_text(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        messagebox.showinfo("Победитель!", "Игрок 1 выиграл")
    elif winner(board, "O"):
        gb.destroy()
        messagebox.showinfo("Победитель!", "Игрок 2 выиграл")
    elif (isfull()):
        gb.destroy()
...
def get_text_pc(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        ...
        gb.destroy()
        x = False
        messagebox.showinfo("Проигрыш!", "Компьютер выиграл")
    elif (isfull()):
        gb.destroy()
        x = False
        messagebox.showinfo("Ничья!", "Победила дружба")
...
def play():
    ...
    B1 = Button(menu, text="1 игрок", command=wpc,
                ...
                width=500, font='summer', bd=25)

    B2 = Button(menu, text="2 игрока", command=wpl, activeforeground='black',
                activebackground="white", bg="black", fg="white",
                width=500, font='summer', bd=25)
